    ...
    <section className="container mx-auto px-2 py-12">
      <div className="flex flex-col gap-4 md:flex-row md:items-stretch">
        ...
        <div className="motion-reveal relative flex-1 overflow-hidden rounded-lg md:hidden">
          ...
          />
          <div className="motion-reveal motion-reveal-fade absolute inset-0 bg-linear-to-t from-black/70 via-black/20 to-transparent" style={{ '--motion-delay': '200ms' } as React.CSSProperties} />
